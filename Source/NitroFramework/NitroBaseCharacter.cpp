...
ANitroBaseCharacter::ANitroBaseCharacter(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer.SetDefaultSubobjectClass<UNinjaCharacterMovementComponent>(ACharacter::CharacterMovementComponentName))
{
	...
	GetNinjaCharacterMovement()->RotationRate = FRotator(0.0f, 500.0f, 0.0f); // ...at this rotation rate
...
void ANitroBaseCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void ANitroBaseCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ANitroBaseCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
